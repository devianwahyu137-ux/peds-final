// Diagnostic script to check health scores across all default scenarios
const ASSET_VOL = {
  stocks: 0.18,
  bonds: 0.06,
  gold: 0.15,
...
for (const [activeSc, data] of Object.entries(SCENARIOS)) {
  for (const [recSc, recData] of Object.entries(SCENARIOS)) {
    ...
    try {
      ...
      if (health.total < 40) {
        console.log(`Active: ${activeSc}, Recommended: ${recSc}, Score: ${health.total}, Details:`, health.scores);
      }
    } catch (e) {
      // ignore
    }
