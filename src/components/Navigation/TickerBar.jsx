...
export const TickerBar = memo(function TickerBar() {
  ...
  return (
    <div className="shrink-0 z-50 w-full overflow-hidden bg-slate-50 dark:bg-neutral-950/90 border-b border-slate-200 dark:border-neutral-900 py-2 flex items-center">
      <div className="animate-ticker-ha flex gap-8 text-[9px] uppercase tracking-widest text-slate-400 dark:text-neutral-500 font-mono">
